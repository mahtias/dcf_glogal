          ...
          <div class="widget-title">
            <ul class="nav nav-tabs">
              ...
              <li>
                ...
                <a data-toggle="tab" @click.prevent="Duree_moyenne">Duree moyenne</a>
               
                </li>
              <li>
                <a data-toggle="tab" @click.prevent="Montant_total">Montant total</a></li>
              <li><a data-togle="tab" @click.prevent="Cout_moyen">Cout moyen  </a></li>
