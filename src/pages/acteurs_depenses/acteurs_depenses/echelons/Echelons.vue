                    ...
                    <div class="widget-box">
                        ...
                        <div class="widget-content nopadding">
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                <tr class="odd gradeX" v-for="(item, index) in echellons" :key="item.id">
            ...
            <div class="modal-body">
                <form class="form-horizontal">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select v-model="formData.classe_id">
                            <option></option>
...
// methode pour maper notre guetter
            ...mapGetters('personnelUA', ['echellons',"classes"])
        ...
        methods: {
            ...
            ajouterTitreLocal () {
                this.ajouterEchelons(this.formData)
                this.formData = {
                    code: "",
                    libelle: ""
                }
